# Runbook — sdkwork-appstore deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-appstore-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-appstore/bundle`, loads the image, starts
