...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `appstore-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `appstore-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `appstore-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `appstore-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `appstore.sdkwork.com` | 443 ssl + 80 |
