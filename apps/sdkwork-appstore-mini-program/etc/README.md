...
Source configuration for `sdkwork-appstore-mini-program`.
...
Format: `mini-program-json`. Output: `../config/mini-program/runtime-env.{deploymentProfile}.{environment}.json` for each
