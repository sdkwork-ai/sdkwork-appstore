    ...
    <div className="flex flex-col xl:flex-row gap-3 items-stretch xl:items-center justify-between min-w-0 w-full">
      <div className="relative flex-1 max-w-md shrink-0">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 bg-white dark:bg-[#1b1e26] border border-gray-200 dark:border-[#282c38] rounded-2xl text-xs focus:outline-none focus:border-purple-500 text-gray-900 dark:text-gray-100 placeholder-gray-400"
        />
      </div>
