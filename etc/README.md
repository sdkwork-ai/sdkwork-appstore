# sdkwork-appstore Source Configuration
...
| Item | Value |
| --- | --- |
| `appId` | `sdkwork-appstore` |
| `runtimeCode` | `appstore` |
| Config root | `/etc/sdkwork/appstore/` |
| Runtime TOML | `/etc/sdkwork/appstore/config.toml` |
| Secrets | `/etc/sdkwork/appstore/secrets/` |
| Override | `SDKWORK_APPSTORE_CONFIG_FILE` |
