...
export interface WishlistAppstoreWishlistItemsListParams {
  cursor?: string;
  pageSize?: number;
}
...
/** List wishlist items */
  async list(params?: WishlistAppstoreWishlistItemsListParams, requestOptions?: ApiRequestOptions): Promise<{ items: WishlistItem[]; pageInfo: PageInfo; }> {
